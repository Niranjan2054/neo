				...
				<div class="col-lg-12">
					<div class="page-banner-text text-center">
						...
						<ul class="site-breadcrumb text-black">
							...
							<li><a href="#">Success Gallery</a></li>
						</ul>
					</div>
				</div>
			</div>
										...
										<div class="col-lg-3 col-md-6 col-sm-12">
											<div class="single-product">
												<div class="product-thumb-sin">
													...
													?>
													<a href="student-detail?c=<?php echo($student->id) ?>"><img src="<?php echo $thumbnail; ?>" alt="" /></a>
													<div class="product-action">
														<a href="student-detail?c=<?php echo($student->id) ?>" class="add-to-cart">
															<span><?php echo $student->name; ?></span>
														</a>
													</div>
												</div>
												<div class="product-text">
													<h4><a href="student-detail?c=<?php echo($student->id) ?>"><?php echo $student->name; ?></a></h4>
