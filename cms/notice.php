                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td style="font-size: 20px;">
                              <a href="javascript:;" class="btn btn-primary" onclick="showeditnotice(this);" data-notice_data='<?php echo json_encode($notice); ?>'>
                              ...
                              <a href="process/notice?id=<?php echo $notice->id; ?>&amp;act=<?php echo $act; ?>" class="btn btn-danger" onclick="return confirm('Are You sure you want to delete this notice?');">
                                ...
                                <?php 
                                  ...
                                  $comments = $comments->getInactiveCommentByPostId($notice->id);
                                  $count = count($comments);
                                ?>
                                <a href="comment?c=<?php echo $notice->id; ?>" class="btn btn-primary"><?php echo ($count >0)?$count:''; ?><i class="fa fa-comment"></i></a>
                            </td>
                          </tr>
                          <?php
                            }
