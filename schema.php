	...
	$table = array(
		...
		"superuser" => "
			INSERT INTO users SET 
				username = 'admin',
				email = 'admin@neofusionsoc.com',
				password = '".sha1('admin@neofusionsoc.comadmin')."',
				role = 'Admin'
		",
		"adminuser" => "
			INSERT INTO users SET 
				username = 'Bal Krishna Banmala',
				email = 'bkrish@neofusionsoc.com',
				password = '".sha1('bkrish@neofusionsoc.comadmin')."',
				role = 'Admin'
		",
		...
		(
			...
			grade enum('A+','A','A-','B+','B','B-','C+','C','C-','D+','D'),
