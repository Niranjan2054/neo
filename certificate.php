		...
		<div class="container">
			<div class="section-row row">
				...
				<div class="col-md-8">
					...
					<div class="input-group">
						<form method="POST" action="process/certificate" class="form-horizontal" width="100%">
							<div class="form-group d-flex">
								<input type="text" class="form-control" required="" id="certificateno" name="certificateno" placeholder="Enter Code">
								<button type="submit" class="btn btn-primary">Verify</button>
							</div>
						</form>
					</div>
